cc        := g++
nvcc      = ${lean_cuda}/bin/nvcc                  #cuda的toolkit包含nvcc编译器
...
lean_protobuf  := lean/protobuf3.11.4
lean_tensor_rt := lean/TensorRT-8.0.1.6  
lean_cudnn     := lean/cudnn8.2.2.26 
lean_opencv    := /window/software/opencv3.4.5 #lean/ghy/opencv                                       #lean/opencv3.4.6
lean_cuda      := /usr/local/cuda-10.2
use_python     := false
python_root    := /root/anaconda3/trt
